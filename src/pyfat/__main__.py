...
def main():
    ...
    with PySaxonProcessor(license=False) as proc:
        ...
        for k, v in Preprocessor.get_nspace_map().items():  # namespaces are defined in a seperate namespaces.json. Could be included in the Metrics file as well
            ...
            for metric in Preprocessor.get_metrics():
                ...
                for metric_test in metric["metric_tests"]:
                    ...
                    for metric_test_requirement in metric_test["metric_test_requirements"]:
                        if metric_test_requirement["test"].startswith("xpath:"):  # 4: In Xpath handler... TODO: implement logic for different handlers here (i.e: xpath, Python, etc. Factory)
